                                    ...
                                    @csrf
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                id="nama_kategori" aria-describedby="emailHelp"
                                                placeholder="Enter Email Address..." name="nama_kategori">
                                    ...
                                    @enderror
                                        ...
                                        <div class="form-group">
                                            <input type="file" class="form-control form-control-user"
                                                ...
                                                placeholder="Enter Email Address..." name="gambar">
                                                <small class="text-danger">
                                                @error('gambar')
                                    {{$message}}
                                    @enderror
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                id="deskripsi" placeholder="Password" name="deskripsi">
                                                <small class="text-danger">
                                        @error('deskripsi')
                                    {{$message}}
                                    @enderror
