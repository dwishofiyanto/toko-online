@extends('layout.app')
@section('titile','Data Pesanan Dikemas')
@section('content')

<div class="card shadow">
    <div class="card-header">
        <h4 class="card-title">Data Pesanan Dikemas</h4>
    </div>
      ...
      success : function({data})
      {
        ...
        data.map(function(val, index)
        {
          row += `<tr>
                  ...
                  <td><a id="konfirmasi" data-id="${val.id}" class="btn btn-warning tombol-aksi">KIRIM PESANAN</a> </td>
             </tr>`;
        });
        $('tbody').append(row);
      }
