@extends('layout.app')
@section('titile','Data Pesanan Dikirim')
@section('content')

<div class="card shadow">
    <div class="card-header">
        <h4 class="card-title">Data Pesanan Dikirim</h4>
    </div>
      ...
      success : function({data})
      {
        ...
        data.map(function(val, index)
        {
          row += `<tr>
                  ...
                  <td><a id="konfirmasi" data-id="${val.id}" class="btn btn-warning tombol-aksi">TERIMA PESANAN</a> </td>
             </tr>`;
        });
