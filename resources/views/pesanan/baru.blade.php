@extends('layout.app')
@section('titile','Data Pesanan Baru')
@section('content')
  ...
  function tampil_data(){
   $.ajax({
      ...
      success : function({data})
      {
       ...
       {
        $('.auto-load').hide();
        $('#nodata').append(`<p class="fw-bolder">Tidak ada data</p>`);
       }
       else
       {
        let row;
        data.map(function(val, index)
        {
          row += `<tr>
                  ...
                  <td><a id="konfirmasi" data-id="${val.id}" class="btn btn-warning tombol-aksi">KONFIRMASI</a> </td>
             </tr>`;
        });
        $('.auto-load').hide();
